                                    ...
                                    <div className="singleLocaInfoMainSection">
                                                                        ...
                                                                        <ul className={`singleLocaCarouselList ${slide ? "singleLocaCarouselTwo" : "singleLocaCarouselOne"}`}>
                                                                            {location.images.map(singleImage => (
                                                                                <li key={singleImage}
                                                                                    ...
                                                                                    <div
                                                                                        className="singleLocaCarouselImageInner">
                                                                                        <img
                                                                ...
                                                                <button
                                                                    ...
                                                                    <div className="singleLocaCarouselLeftButtonInner">
                                                                        <svg width="24" height="24" overflow="visible"
                                                                             ...
                                                                             stroke="#FFFFFF" icon="chevronLeft">
                                                                            <path d="M4 12L20 4L20 20L4 12Z"></path>
                                                                        </svg>
                                                                    </div>
                                                                </button>
                                                                <button
                                                                    ...
                                                                    <div className="singleLocaCarouselLeftButtonInner">
                                                                        <svg width="24" height="24" overflow="visible"
                                                                             ...
                                                                             strokeWidth="0"
                                                                             viewBox="0 0 25 25" fill="#FFFFFF"
                                                                             stroke="#FFFFFF" icon="chevronRight">
                                                                            <path d="M20 12L4 20L4 4L20 12Z"></path>
                                                                        </svg>
                                                                    </div>
                                                                </button>
                                                                <div className="singleLocaCarouselCapacity">
                                                                    <img
                                                                        src="https://book.pirate.com/static/media/capacity-white.9786fb66.svg"
                                                                        alt={location.capacity}/>
                                                                    <span
                                                ...
                                                <div className="singleLocaInfoDetailsInner">
                                                   ...
                                                   11.63V4.35999C16 3.29912 15.5785 2.2817 14.8284 1.53156C14.0782 0.78141 13.0608 0.359985 12
                                                    ...
                                                    10.9608 13.4193 10.5858 13.0442C10.2107 12.6691 9.99996 12.1604 9.99996 11.63V4.35999Z"></path>
                                                                ...
                                                                <div className="ps-1">
                                                                    ...
                                                                    <div
                                                                        className="singleLocaDetailEquipText">{location.details[0].description}</div>
                                                                </div>
                                                            </div>
                                                  ...
                                                  5.57858C19.2706 7.16975 20.0911 9.29532 20.04 11.49V13.95H17.04V22.95H22.04L24.04 20.95V15.95L22.04 13.95Z"></path>
                                                                ...
                                                                <div className="ps-1">
                                                                    ...
                                                                    <div
                                                                        className="singleLocaDetailEquipText">{location.details[1].title}</div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="singleLocaDetailEquipItem">
                                                                <div className="singleLocaDetailEquipIcon">
                                                                    <svg width="24" height="24" overflow="visible"
                                                                         preserveAspectRatio="xMinYMin meet"
                                                                         strokeWidth="0" viewBox="0 0 25 25"
                                                                         fill="#000000" stroke="#000000" icon="audio"
                                                                         className="sc-eXuyPJ sjfVN">
                                                  ...
                                                  13.9631C3.55363 14.2649 3.30228 14.5155 3 14.69V18.48C3 20.5 4.26 21.97 6 21.97C7.74 21.97 9 20.48 9 18.48V8.47998Z"></path>
                                                                ...
                                                                <div className="ps-1">
                                                                    ...
                                                                    <div
                                                                        className="singleLocaDetailEquipText">{location.details[2]?.title}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="paymentColumn">
                                            <div className="paymentColumnInner">
                                                ...
                                                <div
                                                    className="paymentColumnDate">{timeStampToDate(filters.startDate).toDateString().slice(0, 10)} - {timeStampToDate(filters.finishDate).toDateString()}</div>
                                                ...
                                                <div className="paymentCardsIcons">
                                                    <img className="paymentCardsIcon"
                                                         src="https://book.pirate.com/static/media/visa-logo.d9f67f79.svg"
                                                         alt="visa"/>
                                                    <img className="paymentCardsIcon"
                                                         src="https://book.pirate.com/static/media/mastercard-logo.5613174f.svg"
                                                         alt="mastercard"/>
                                                    <img className="paymentCardsIcon"
                                                         src="https://book.pirate.com/static/media/american-express-logo.8982b953.svg"
                                                         alt="amexp"/>
                                                    <img className="paymentCardsIcon"
                                                         src="https://book.pirate.com/static/media/apple-pay-logo.a744afb2.svg"
                                                         alt="applepay"/>
                                                    <img className="paymentCardsIcon"
                                                         src="https://book.pirate.com/static/media/google-pay-logo.7acf5d5b.svg"
                                                         alt="googlepay"/>
                                                </div>
